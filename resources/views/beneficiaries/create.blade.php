...
<body>
    <div class="container py-5">
        <h1><i class="fa-solid fa-user-plus me-2"></i>Tambah Penerima Bantuan</h1>
        ...
        <form action="{{ route('beneficiaries.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="status_ekonomi" class="form-control @error('status_ekonomi') is-invalid @enderror" required>
